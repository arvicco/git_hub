...
#tags and #branches returned as a hash of (latest) commits, with tag/branch name as keys.
#commits returns an array of ALL commit objects for a repo (may take a while to load)  
